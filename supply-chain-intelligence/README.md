...
curl -s "https://api.apitube.io/v1/news/everything?api_key=YOUR_API_KEY&title=shipping,freight,port,container&per_page=20"

# Monitor semiconductor supply chain
curl -s "https://api.apitube.io/v1/news/everything?api_key=YOUR_API_KEY&title=chip shortage,supply,production,fab&per_page=20"
```
